...
*               : The RX is clocked by a 12 MHz oscillator provided by 
*                 EPSON.  EPSON also provides the 32 kHz oscillator used by 
*                 the Real-Time Clock (RTC) and the 25 MHz crystal that drives
*                 the PHY for Ethernet communications.
* Argument      : none
* Return value  : none
******************************************************************************/
void ConfigureOperatingFrequency(void)
{
    ...
    err &=     R_CGC_Set
               (
               12E6,       // main input      clock      in Hz
               96E6,       // internal system clock ICLK in Hz
               48E6,       // peripheral      clock PCLK in Hz
               24E6,       // external bus    clock BCLK in Hz
               PDL_NO_DATA // config options
               );
    /* 
