...
void PowerON_Reset_PC(void)
{
    ...
    nop();
    set_psw(PSW_init);
	// DO NOT CHANGE TO USER MODE IF USING FREERTOS!
	// FreeRTOS uses privleged instructions so don't go to UserMode;
	// Stay in Supervisor mode by not performing the call:
